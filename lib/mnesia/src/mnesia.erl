...
system_info2(send_max_packets) -> mnesia_monitor:get_env(send_max_packets);
system_info2(send_max_transfer_size) -> mnesia_monitor:get_env(send_max_transfer_size);
